...
*/
#ifndef V1_COMMONAPI_EXAMPLES_Helloworld_PROXY_HPP_
#define V1_COMMONAPI_EXAMPLES_Helloworld_PROXY_HPP_

#include <v1/commonapi/examples/HelloworldProxyBase.hpp>
...
public:
    ...
    typedef ::v1::commonapi::examples::Helloworld InterfaceType;
...
struct DefaultAttributeProxyHelper< ::v1::commonapi::examples::HelloworldProxy,
    _AttributeExtension> {
    typedef typename ::v1::commonapi::examples::HelloworldProxy<
            ::v1::commonapi::examples::HelloworldExtensions::XAttributeExtension<_AttributeExtension>, 
            ::v1::commonapi::examples::HelloworldExtensions::A1AttributeExtension<_AttributeExtension>
    > class_t;
};
}
...
#endif // V1_COMMONAPI_EXAMPLES_Helloworld_PROXY_HPP_
