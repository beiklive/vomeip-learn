 ...
 */
#include <v1/commonapi/examples/HelloworldSomeIPStubAdapter.hpp>
...
std::shared_ptr<CommonAPI::SomeIP::StubAdapter> createHelloworldSomeIPStubAdapter(
    ...
    return std::make_shared< HelloworldSomeIPStubAdapter<::v1::commonapi::examples::HelloworldStub>>(_address, _connection, _stub);
}
